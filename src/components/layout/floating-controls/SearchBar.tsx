          ...
          {isOpen ? (
            <>
              ...
              <Input
                ...
                className="border-0 bg-transparent shadow-none focus-visible:ring-1 focus-visible:ring-primary focus-visible:border-0 px-0 h-10 dark:bg-transparent hover:bg-transparent dark:hover:bg-transparent"
                value={query}
                onChange={onChange}
                onFocus={onFocus}
              />
